...
<section class="section">
  <div class="wrap detail-grid">
    <div class="detail-body">
      <h3>Get In Touch</h3>
      <p><strong>Office:</strong> Strasbourg, France<br><strong>Email:</strong> hello@noevara.com<br><strong>Response time:</strong> Within one business day</p>
    </div>
    <aside>
      <form id="contactForm">
